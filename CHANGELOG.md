## 7.1.32 2022-12-20 <dave at tiredofit dot ca>

   ### Changed
      - Fix for nextcloud schema not loading on startup


## 7.1.31 2022-07-09 <dave at tiredofit dot ca>

   ### Added
      - Pin to tiredofit/openldap:2.4-7.1.32
...
## 7.1.29 2022-05-24 <dave at tiredofit dot ca>
   ...
   ### Added
      ...
      - Remove Schema2LDIF as its already in upstream


## 7.1.28 2022-05-15 <dave at tiredofit dot ca>

   ### Changed
      - Change where SchemaLDIF is installed from
