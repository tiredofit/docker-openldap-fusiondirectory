...
[![Build Status](https://img.shields.io/github/actions/workflow/status/tiredofit/docker-openldap-fusiondirectory.git/main.yml?branch=main&style=flat-square)](https://github.com/tiredofit/docker-openldap-fusiondirectory.git/actions)
